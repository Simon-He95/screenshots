...
import Screenshots, { Bounds } from "fast-react-screenshots";
...
- electron 中使用可直接加载渲染进程的页面，页面路径为`require.resolve('fast-react-screenshots/electron/electron.html')`，不推荐自己手动开发主进程，推荐直接使用`fast-electron-screenshots`模块
