...
export default function Ok (): ReactElement {
  const {
    image, imageWidth, imageHeight, width, height, history, bounds, lang
  } = useStore()
  ...
  }, [canvasContextRef, historyDispatcher, image, imageWidth, imageHeight, width, height, history, bounds, call, reset])
